...
export default function CafeDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50">
      ...
      <button 
        onClick={toggleMenu}
        className="md:hidden fixed top-6 left-6 z-50 bg-white/90 backdrop-blur-md p-3 rounded-xl shadow-lg"
      >
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="md:hidden fixed inset-0 z-40 bg-white/95 backdrop-blur-lg flex flex-col items-center justify-center space-y-8">
          <button 
            onClick={() => scrollToSection('menu')}
            className="text-2xl font-bold text-amber-900 hover:text-orange-600 transition-colors"
          >
            Menu
          </button>
          <button 
          ...
          <div className="absolute bottom-8 flex items-center gap-4">
            <button className="bg-amber-600 text-white px-6 py-3 rounded-xl font-semibold">
              Order Now
            </button>
            {cartItems.length > 0 && (
              <div className="relative">
      ...
      <div className="w-full">
        ...
        {/* Menu Section */}
        <section id="menu" className="py-20 px-6 bg-white/30 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-5xl font-bold mb-6">
                <span className="text-amber-900">Signature</span>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-center">
                      <button 
                        ...
                        className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-600 to-orange-600 text-white px-4 py-2 rounded-full font-bold shadow-lg hover:from-amber-700 hover:to-orange-700 transition-all"
                      >
                        {item.price}
        ...
        {/* Testimonials Section */}
        <section id="testimonials" className="py-20 px-6 bg-gradient-to-br from-amber-900 to-orange-900 text-white relative overflow-hidden">
          {/* Background Elements */}
          <div className="absolute inset-0">
            <div className="absolute top-10 left-10 w-64 h-64 bg-white/5 rounded-full blur-3xl"></div>
            <div className="absolute bottom-10 right-10 w-80 h-80 bg-white/5 rounded-full blur-3xl"></div>
        ...
        {/* Footer */}
        <footer id="contact" className="bg-gradient-to-br from-amber-950 to-orange-950 text-white py-16 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-amber-600 to-orange-600 rounded-2xl flex items-center justify-center">
      ...
      {cartItems.length > 0 && (
        <button 
          ...
          className="fixed bottom-6 left-6 z-40 bg-gradient-to-r from-amber-600 to-orange-600 text-white p-4 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-110 flex items-center"
        >
          <ShoppingCart className="w-6 h-6" />
          <span className="absolute -top-2 -right-2 bg-rose-500 text-white text-sm font-bold rounded-full w-6 h-6 flex items-center justify-center">
            {cartItems.length}
          </span>
        </button>
      )}
